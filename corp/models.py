...
class Caracteristicasmetrologicas(models.Model):
    ...
    idsenhalunif = models.ForeignKey('Señalesunificadas', models.DO_NOTHING, db_column='IdSeñalUnif', blank=True,
                                     null=True,
    ...
    senhalunifiddb = models.ForeignKey('Señalesunificadas', models.DO_NOTHING, db_column='SeñalUnifIdDB',
...
class Localizaciones(models.Model):
    idemp = models.ForeignKey('Empresas', models.DO_NOTHING, db_column='IdEmp', primary_key=True,
...
class Municipios(models.Model):
    idmun = models.IntegerField(db_column='IdMun', primary_key=True)  # Field name made lowercase.
...
class Provincias(models.Model):
    idprov = models.IntegerField(db_column='IdProv', primary_key=True)  # Field name made lowercase.
...
class Señalesunificadas(models.Model):
